			...
			<div className="container max-w-7xl mx-auto px-4 md:px-6 py-6">
				...
				>
					<TabsList className={cn(
						"flex flex-wrap h-auto w-full items-stretch justify-start p-2 gap-2 mb-6",
						glass("tabInactive")
					)}>
						<TabsTrigger value="profile" className={cn(
							"justify-start gap-2 px-4 py-3 transition-all text-sm font-medium rounded-lg whitespace-nowrap min-h-[44px]",
							glass("tabActive"),
							glass("tabInactive")
						)}>
						...
						{isLoading ? (
							...
							<>
								...
								<TabsContent value="billing" className="mt-0">
									<Card className={cn("border-none shadow-none bg-transparent")}>
										<CardContent className="py-12 text-center text-muted-foreground px-0">
